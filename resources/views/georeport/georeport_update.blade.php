        ...
        <div class="body-content" >
          ...
          @include('include/top_bar')
            ...
            <div class="page-head">
                ...
                <h3 class="m-b-less">Update Geotechnical Report</h3>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div id="alert_message"></div>
                                <form role="form" id="update_georeport_form">
                                    <div class="row">
                                <!--     <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="name_of_report">Report Name</label>
...
<!--                                        <a data-href="{{ url('/dashboard/'.$project_id.'/geo_reports') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
                                        <a href="{{ url('/dashboard/'.$project_id.'/geo_reports') }}" class="btn btn-info sub-btn btn_back1">Back</a>
...
<script src="{{ url('/resources/assets/dist/georeport_update.js') }}"></script>
