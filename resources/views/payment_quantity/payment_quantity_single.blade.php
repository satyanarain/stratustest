        ...
        <div class="body-content" >
          ...
          @include('include/top_bar')
            ...
            <div class="page-head">
                ...
                <h3 class="m-b-less">Payment Quantity Verification Report Month : <span id="month_name"></span></h3>
...
<script src="{{ url('/resources/assets/dist/payment_quantity_verification_single.js') }}"></script>
