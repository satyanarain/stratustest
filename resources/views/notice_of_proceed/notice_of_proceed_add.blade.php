...
<div class="col-md-12">
    <div class="row">
        ...
        <div class="col-sm-12 nopadleft">
            <div class="col-md-12 check_award_type" style="margin-bottom:50px;">
                ...
                <label class="radio-inline">
                    <input type="radio" name="check_award_type" id="upload" value="new">  Notice to Proceed
                </label><br/>
                <label class="radio-inline">
                    <input type="radio" name="check_award_type" id="upload" value="exist"> Already have Notice to Proceed
                </label>
            </div>
        ...
        <div class="col-sm-6 nopadleft">
            <div class="notice_exist" style="display: none;">
                <div class="form-group col-md-12">
                    <label for="name_of_report" style="padding-top: 15px;">Upload Notice of Proceed <span class="text-danger">*</span></label>
        ...
        <div class="clearfix"></div>
        <div class="form-group col-md-6 signature_column" style="display: none;">
            <label>Owner</label>
            <select class="form-control contact_project" id="sign_owner_id"></select>
        </div>
        <div class="form-group col-md-6 signature_column" style="display: none;">
            <label>Contractor</label>
            <select class="form-control contact_project" id="sign_contractor_id"></select>
        </div>

        <div class="form-group col-md-12">
<!--            <a data-href="{{ url('/dashboard/'.$project_id.'/notice_of_proceed') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body" id="docusign_box" style="padding: 0px;">
