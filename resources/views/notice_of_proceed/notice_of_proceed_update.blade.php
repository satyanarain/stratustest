...
<div class="form-group col-md-6">
    ...
    <div class="before_review_owner" style="display: none;">
        <label for="name_of_report" style="padding-top: 15px;">Upload document after Singing</label>
    ...
    <div class="after_review_owner" style="display: none;">
        <p><strong>Singing Document: </strong><div id="document_owner"></div></p> 
        <br/>
        <p><strong>Review Owner: </strong><span id="review_owner_detail"></span></p>
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="after_review_contractor" style="display: none;">
        <p><strong>Singing Document: </strong><div id="document_contractor"></div></p> 
        <br/>
        <p><strong>Review Contractor: </strong><span id="review_contractor_detail"></span></p>
    </div>
</div>
<div class="clearfix"></div>
                                    <div class="col-md-6">
