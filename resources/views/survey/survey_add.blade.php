...
<div style="width:100%;float:left;" id="pdf_content">
    <div style="width:100%;float:left;">
        <div style="width: 50%;float: left;">
            <img src="http://ec2-34-236-61-80.compute-1.amazonaws.com/resources/assets/img/pdf-logo.jpg">
            <b><br>1151 Duryea Ave.
            <br>Irvine, CA 92614
            <br>Tel: 949.988.3270</b>
        </div>
        <div style="width: 50%; float:left">
            <h2>Survey Request For:</h2>
            <div style="width: 100%;border-bottom: 1px solid black;color: red;">Friday, May 09, 2014</div>
            <div style="width: 100%;"><b>Date Service Needed</b></div>
            <div style="width: 100%;border-bottom: 1px solid black;color: red;">12:00 AM</div>
            <div style="width: 100%;"><b>Time Service Needed</b></div>
        </div>
    </div>
    <div style="width:100%;float:left;">
        ...
        <div style="width: 45%;float: left;">
        	<div style="width: 40%;float: left; min-height:25px;">
            	Contact Person:
            </div>
            <div style="width: 60%;float: left; border-bottom:1px solid #000; min-height:25px;">
...
<div id="pdf_content1" style="width:80%; display:;">
