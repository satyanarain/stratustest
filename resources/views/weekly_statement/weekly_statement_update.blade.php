    ...
    <table class="table">
        ...
        <tr>
            ...
            <td  style="text-align: center; font-weight: 600; vertical-align: middle;"><input type="number" min="0" max="1" id="days_this_report_app_calender" name="days_this_report_app_calender" class="form-control" required="required" onchange="checkvalue1(this)"></td>
            <td style="text-align: center; font-weight: 600; vertical-align: middle;"><input type="number" min="0" max="1" id="days_this_report_app_non_calender" name="days_this_report_app_non_calender" class="form-control" required="required" onchange="checkvalue1this)"></td>
            <td></td>
        </tr>
        <tr>
            <td colspan="2" style="vertical-align: middle;">7. Days Previously Reported:</td>
            <td style="text-align: center; font-weight: 600; vertical-align: middle;"><input type="number" min="0" max="1" id="days_previous_report_app_calender" name="days_previous_report_app_calender" class="form-control" required="required" onchange="checkvalue1(this)"></td>
            <td id="" style="text-align: center; font-weight: 600; vertical-align: middle;"><input type="number" min="0" max="1" id="days_previous_report_app_non_calender" name="days_previous_report_app_non_calender" class="form-control" required="required" onchange="checkvalue1(this)"></td>
            <td></td>
        </tr>
        <tr>
...
<script src="{{ url('/resources/assets/dist/weekly_report_update.js') }}"></script>
