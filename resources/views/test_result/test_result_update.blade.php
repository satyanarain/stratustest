        ...
        <div class="body-content" >
          ...
          @include('include/top_bar')
            ...
            <div class="page-head">
                ...
                <h3 class="m-b-less">Update Test Results</h3>
...
<!--                                        <a data-href="{{ url('/dashboard/'.$project_id.'/test_result') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
                                        <a href="{{ url('/dashboard/'.$project_id.'/test_result') }}" class="btn btn-info sub-btn btn_back1">Back</a>
                                        <button type="submit" id="update_test_result_form" class="btn btn-info sub-btn">Save</button>
...
<script src="{{ url('/resources/assets/dist/test_result_update.js') }}"></script>
