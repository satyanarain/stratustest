        ...
        <div class="body-content" >
          ...
          @include('include/top_bar')
            ...
            <div class="page-head">
                ...
                <h3 class="m-b-less">Update Bid Document</h3>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div id="alert_message"></div>
                                   ...
                                   <form role="form" id="update_bond_form">
                                    <div class="row">
...
<!--                                        <a data-href="{{ url('/dashboard/'.$project_id.'/bid_documents') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
                                        <a href="{{ url('/dashboard/'.$project_id.'/bid_documents') }}" class="btn btn-info sub-btn btn_back1">Back</a>
...
<script src="{{ url('/resources/assets/dist/bid_document_update.js?v=1.0') }}"></script>
