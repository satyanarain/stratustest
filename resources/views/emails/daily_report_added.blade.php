...
<h3>New Daily Report Added</h3>

<p>Dear <?php echo $user->name; ?>,&nbsp;</p>

<p class="p1">New Daily Report added in Project: <strong><?php echo $user->project_name; ?></strong> <a href="{{ url('/') }}<?php echo $user->link; ?>"> Click Here to see </a></p>
