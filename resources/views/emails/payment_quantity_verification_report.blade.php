...
<table border="0"  cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td align="right" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12pt; color: #777; font-weight: normal; line-height: 1.45;color:#6f6f6f;">New Payment quantity verification monthly report <?php echo $user->month_name; ?> has been generated<br><?php echo $user->date; ?></td>
	</tr>
</table>
...
<p class="p1" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12pt; color: #777; font-weight: normal; line-height: 1.45;">New Payment quantity verification monthly report <?php echo $user->month_name; ?> has been generated in Project: <strong><?php echo $user->project_name; ?></strong> <a href="{{ url('/') }}<?php echo $user->link; ?>"> Click Here to see </a></p>
