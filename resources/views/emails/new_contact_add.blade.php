...
<p class="p1">New contact <?php echo $user->contact_name; ?> has been added in Project: <strong><?php echo $user->project_name; ?></strong> <a href="{{ url('/') }}<?php echo $user->link; ?>"> Click Here to see </a></p>
