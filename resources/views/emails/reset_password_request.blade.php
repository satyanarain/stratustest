...
<p class="p1" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12pt; color: #777; font-weight: normal; line-height: 1.45;">Your request to reset password has been accpeted, your verification code is: <strong><?php echo $user->verification_code; ?></strong><br/> Please visit the link below.</p>
