...
<p class="p1" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12pt; color: #777; font-weight: normal; line-height: 1.45;background: #5aaaba;
    padding: 25px 0px;
    text-align: center;"><a href="<?php echo (url('users/email_verification', $user->user_id )); ?>" style="color: #fff; text-decoration: none; font-size: 18px;">Click Here</a></p>
