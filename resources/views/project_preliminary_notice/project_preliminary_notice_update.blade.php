...
<!--                                        <a data-href="{{ url('/dashboard/'.$project_id.'/preliminary_notice_log') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
                                        <a href="{{ url('/dashboard/'.$project_id.'/preliminary_notice_log') }}" class="btn btn-info sub-btn btn_back1">Back</a>
...
<script src="{{ url('/resources/assets/dist/preliminary_update.js') }}"></script>
