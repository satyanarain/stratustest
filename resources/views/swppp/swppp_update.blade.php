        ...
        <div class="body-content" >
          @include('include/top_bar')
            ...
            <div class="page-head">
                ...
                <h3 class="m-b-less">Update SWPPP / WPCP</h3>
...
<!--                                        <a data-href="{{ url('/dashboard/'.$project_id.'/swppp') }}" class="btn btn-info sub-btn back_button" data-toggle="modal" data-target="#confirm-back">Back</a>-->
                                        <a href="{{ url('/dashboard/'.$project_id.'/swppp') }}" class="btn btn-info sub-btn btn_back1">Back</a>
...
<script src="{{ url('/resources/assets/dist/swppp_update.js') }}"></script>
