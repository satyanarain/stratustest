                        ...
                        <section class="panel">
                            <div class="panel-body">
                                <div class="upload_doc_panel_performance">    
                                    <header class="panel-heading">Would you like to create a contract or has one already been created?</header>
                                    <div class="col-md-6 nopadleft">
                                        <div class="form-group">
                                            <div class="col-lg-10">
                                                <label class="checkbox-custom check-success">
                                                    <input type="checkbox" value=" " id="check1">
                                                    <label for="check1">Create Contract</label>
                                                </label>
                                                <label class="checkbox-custom check-success">
                                                    <input type="checkbox" value=" " id="check2">
                                                    <label for="check2">Already have Contract</label>
                                                </label>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label for="name_of_report" style="padding-top: 15px;">Contractor</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <button class="btn btn-info sub-btn">Create Contract</button>
                                    </div>
