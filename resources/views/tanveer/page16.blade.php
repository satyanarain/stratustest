        ...
        <div class="body-content" >
          ...
          @include('include/top_bar')
            ...
            <!-- page head start-->
            <div class="page-head">
                <h3 class="m-b-less">Notice to Proceed</h3>
                                ...
                                <div class="upload_doc_panel_performance">    
                                    ...
                                    <div class="col-md-6 nopadleft">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="name_of_report" style="padding-top: 10px;">Date of Notice</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-10">
                                                <label class="checkbox-custom check-success">
                                                    ...
                                                    <label for="check1">Calendar Days</label>
                                                </label>
                                                <label class="checkbox-custom check-success">
                                                    <input type="checkbox" value=" " id="check2">
                                                    <label for="check2">Working Days</label>
                                                </label>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-12">
                                            <label class="col-md-4 nopadleft" style="padding-top: 5px;">Liquidated Damages</label>
                                            <div class="col-md-4"><input type="text" class="form-control" id="performance_bond_number"></div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <button class="btn btn-info sub-btn">Create Notice to Proceed</button>
                                    </div>
