...
<!--                    <div class="profile-pic-container custom-pull-top">
                         <div class="circle1">
                           <img class="profile-pic profile-pic-js" src="/resources/assets/img/logo.png">
                             <img class="profile-pic profile-pic-js" src="">
                         </div>
                         <div class="p-image">
...
<!--                   <div class="profile-pic-container custom-pull-left">
                     <div class="circle1">
                       <img class="profile-pic profile-pic-js1" src="/resources/assets/img/logo-icon.png">
                         <img class="profile-pic profile-pic-js1" src="">
                     </div>
                     <div class="p-image">
                ...
                <ul class="notification-menu  hide_admin">
                <!--mail info start-->
                <li>
                    <a href="" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="text-transform: capitalize;line-height: 35px;">
                        Switch Project
                    </a>
                    <div class="dropdown-menu dropdown-usermenu purple project-drop">
                        <ul class="drpdown-scroll" id="all_user_project">
                            <!-- <li>
                ...
                <li>
                    <a href="javascript:;" class="btn btn-default dropdown-toggle info-number" data-toggle="dropdown">
                        ...
                        <span class="badge bg-warning unread_notification"></span>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-title ">
                        ...
                        <div class="title-row">
                            <h5 class="title yellow">
                                You have <span class="unread_notification"></span> New Notification
                            </h5>
                            <a href="{{ url('/dashboard/notification') }}" class="btn-warning btn-view-all">View all</a>
                        </div>
                        <div class="notification-list-scroll sidebar">
                            <div class="notification-list mail-list not-list" id="notification_list">
                               <!--  <a href="javascript:;" class="single-mail">
                                    <span class="icon bg-primary">
                                        <i class="fa fa-envelope-o"></i>
                                    </span>
                ...
                <div class="right-notification">
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="" class="btn btn-default dropdown-toggle" data-toggle="dropdown"  id="login_username" style="text-transform: capitalize;">
