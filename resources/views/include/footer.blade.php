...
function checkFormFilled(classname)
{
    ...
    $("input[type=text],select").each(function(key,value) {
        ...
        var exempted_val = ["2","cy","Select Contract Item","Add New Company","Select Improvement Type","Select Improvement Types","Add New Entity","Add New Agency","Orange County, CA, USA","1"];
        var exempted_array = ["built_filed_on","company_type","material_unit_type","date_of_submittal","submittal_number_exist","project_terms","umbrella_liability_cur_symbol","general_liability_cur_symbol","company_name_two","maintenance_bond_cur_symbol","payment_bond_cur_symbol","performance_bond_cur_symbol", 
    ...
    "notice_award_project_type_dropdown","notice_award_company_name","notice_award_bid_amount","notice_award_date","rfi_days_type","submittal_days_type","change_order_days_type"];
