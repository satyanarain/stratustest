...
function checkFormFilled(classname)
{
    ...
    $("input[type=text],select").each(function(key,value) {
        ...
        var exempted_val = ["2","cy","Select Contract Item","Add New Company","Select Improvement Type","Select Improvement Types","Add New Entity","Add New Agency","Orange County, CA, USA","1","f","a"];
