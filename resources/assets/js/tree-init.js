    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource2 = new DataSourceTree({
                data: [
                    { name: 'Standards <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: 'Specifications <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: 'Plans <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F13' } },
