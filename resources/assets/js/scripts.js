...
(function() {
   ...
   jQuery('.menu-list-sub > a').click(function() {
   ...
   function visibleSubMenuLevel2Close() {

      jQuery('.menu-list-sub').each(function() {
         var t = jQuery(this);
         if(t.hasClass('nav-active')) {
            t.find('> ul').slideUp(300, function(){
               t.removeClass('nav-active');
