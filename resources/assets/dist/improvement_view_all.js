			...
			jQuery.each( data.data, function( i, val ) {
				...
				if(role == 'owner'){
				  	t.row.add([
			           ...
			           val.pt_name,
			           status,
	                   '<a href="'+baseUrl+'dashboard/improvement/'+val.pt_id+'/update" class="btn btn-primary btn-xs tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>'
			       	]).draw( false );
			       	count++;
			  }else {
				t.row.add([
