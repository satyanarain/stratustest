$(document).ready(function() { 
    ...
    $('.add_standard_form').click(function(e) {
        ...
        if(applicable==true){
            ...
            if (r == true) {
                window.location.href = baseUrl +"dashboard/"+project_id+"/plans";
            } else {
        ...
        if(standard_name == ''){
            html += '<li>Specification name is invalid.</li>';
            is_error == true;
        }
        if(standard_date == ''){
        ...
        if(standard_link != ''){
            if(standard_link_validation == true){
                ...
                html += '<li>Specification link is invalid.</li>';
                is_error = true;
            }
        }
        ...
        if(is_error == true){
            ...
            .done(function(data, textStatus, jqXHR){
                ...
                $("#alert_message").show();
                html = '<div id="toast-container" class="toast-top-right" aria-live="polite" role="alert" style="margin-top:50px;"><div class="toast toast-success">New specification added successfully!</div></div>';
                $("#alert_message").html(html);
                setTimeout(function()
                {
                    $("#alert_message").hide();
            ...
            .fail(function(jqXHR, textStatus, errorThrown) {
                ...
                if(responseText.data.upload_file != null){
                        html += '<li>The specification document is required.</li>';
                    }
