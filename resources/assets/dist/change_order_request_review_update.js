$(document).ready(function() {
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        if(request_bid_path == null){
            ...
            request_bid_path_value = '<a href="https://apps.groupdocs.com/document-viewer/embed/'+data.data.file_path+'" target="_blank"><img src="'+baseUrl+'resources/assets/img/pdf_icon.png" width="40"/></a>';
