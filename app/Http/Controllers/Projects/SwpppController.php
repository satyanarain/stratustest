        ...
        else
        {
            ...
            else
            {
              ...
              foreach ($check_project_users as $check_project_user) {
                ...
                $project_id           = $project_id;
                $notification_title   = 'Add new SWPPP / WPCP in Project: ' .$check_project_user->p_name;
                $url                  = App::make('url')->to('/');
                $link                 = "/dashboard/".$project_id."/swppp";
                $date                 = date("M d, Y h:i a");
                $email_description    = 'New SWPPP / WPCP added in Project: <strong>'.$check_project_user->p_name.'</strong> <a href="'.$url.$link.'"> Click Here to see </a>';
