              ...
              else
              {
                  ...
                  else
                  {
                    ...
                    foreach ($check_project_users as $check_project_user) {
                      ...
                      $project_id           = $project_id;
                      $notification_title   = 'Add new Standard in Project: ' .$check_project_user->p_name;
                      $url                  = App::make('url')->to('/');
                      $link                 = "/dashboard/".$project_id."/standards";
                      $date                 = date("M d, Y h:i a");

                      if($applicable == 'no'){
                        $email_description    = 'New standard added in Project: <strong>'.$check_project_user->p_name.'</strong> that standard is not applicable yet <a href="'.$url.$link.'"> Click Here to see </a>';
                      }
                      else {
                        $email_description    = 'New standard added in Project: <strong>'.$check_project_user->p_name.'</strong> <a href="'.$url.$link.'"> Click Here to see </a>';
                      }
